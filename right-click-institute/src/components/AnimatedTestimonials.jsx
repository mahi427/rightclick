  ...
  const testimonials = [
    {
      ...
      achievements: ["Perfect Score", "School Topper", "Math Olympiad Winner"]
    },
    {
      id: 2,
      name: "PRIYA VERMA",
      ...
      achievements: ["JEE Advanced Qualified", "State Rank 45", "NTSE Scholar"]
    },
    {
      id: 3,
      name: "AMIT KUMAR",
      ...
      achievements: ["95% in Maths", "Improved by 40%", "Class Representative"]
    },
    {
      id: 4,
      name: "SUNITA RANI",
      ...
      achievements: ["Regular Progress", "Parent Satisfaction", "Trusted Institute"]
    }
  ];
  ...
  return (
    <section id="testimonials" className="py-16 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="grid md:grid-cols-2">
                  ...
                  <div className="p-8 md:p-12">
                    ...
                    <div className="flex items-center">
                      <div className={`w-20 h-20 ${currentTestimonial.imageColor} rounded-full flex items-center justify-center mr-6`}>
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-red-50 p-8 md:p-12">
                        ...
                        >
                          <div className="flex items-center">
                            <div className={`w-3 h-3 rounded-full mr-3 ${
                              currentTestimonial.imageColor === 'bg-blue-500' ? 'bg-blue-500' :
                              currentTestimonial.imageColor === 'bg-red-500' ? 'bg-red-500' :
                              currentTestimonial.imageColor === 'bg-green-500' ? 'bg-green-500' : 'bg-purple-500'
                            }`} />
                    ...
                    <div className="mt-8">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-sm text-gray-600">Success Progress</span>
        ...
        <motion.div 
          className="mt-16 bg-gradient-to-r from-blue-600 to-red-600 text-white rounded-3xl p-8 shadow-2xl"
